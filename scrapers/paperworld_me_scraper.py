"""
Paperworld Middle East 2025 — Exhibitor Scraper
Output: paperworld_me_exhibitors.xlsx  (same directory as this script)
"""
...
BASE_URL = "https://paperworld-middle-east.ae.messefrankfurt.com"
LIST_URL = BASE_URL + "/dubai/en/exhibitor-search.html?page={page}&pagesize=90"
TOTAL_PAGES = 6
OUTPUT_FILE = "/Users/deepakkewal/Desktop/NEW paperworld_me_exhibitors.xlsx"
...
async def main():
    print("Step 1: Collecting exhibitor URLs (6 pages)...")
