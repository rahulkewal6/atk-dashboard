"""
Automechanika Frankfurt 2026 — Exhibitor Scraper
Output: /Users/deepakkewal/Desktop/NEW automechanika_frankfurt_exhibitors.xlsx
"""
...
BASE_URL = "https://automechanika.messefrankfurt.com"
LIST_URL = BASE_URL + "/frankfurt/en/exhibitor-search.html?page={page}&pagesize=90"
TOTAL_PAGES = 360
OUTPUT_FILE = "/Users/deepakkewal/Desktop/NEW automechanika_frankfurt_exhibitors.xlsx"
    ...
    async with async_playwright() as p:
        ...
        for pg in range(1, TOTAL_PAGES + 1):
            ...
            for attempt in range(3):
                try:
                    await page.goto(LIST_URL.format(page=pg), wait_until="domcontentloaded", timeout=90000)
                    await page.wait_for_selector('a[href*="exhibitor-search.detail"]', timeout=30000)
                    break
                except Exception as e:
                    print(f"  Retry {attempt+1} page {pg}: {e}", flush=True)
...
async def main():
    print("Step 1: Collecting exhibitor URLs (360 pages)...")
