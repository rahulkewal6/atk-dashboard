"""
Beauty World KSA (Riyadh) 2025 — Exhibitor Scraper
Output: /Users/deepakkewal/Desktop/NEW beautyworld_ksa_exhibitors.xlsx
"""
...
BASE_URL = "https://beautyworld-riyadh.ksa.messefrankfurt.com"
LIST_URL = BASE_URL + "/ksa/en/exhibitor-search.html?page={page}&pagesize=90"
TOTAL_PAGES = 3
OUTPUT_FILE = "/Users/deepakkewal/Desktop/NEW beautyworld_ksa_exhibitors.xlsx"
...
async def main():
    print("Step 1: Collecting exhibitor URLs (3 pages)...")
